...
(연결된 자식 테이블에 not null 설정하기 전에앞에서 해당 컬럼을 null(= 비워두기)로 해놓으면,
...
insert into author (id, name, email) values(2, 'a', 'ha@naver.com');
insert into author (id, name, email) values(3, 'a', 'ha@naver.com');
insert into author (id, name, email) values(4, 'a', 'ha@naver.com');
insert into author (id, name, email) values(5, 'a', 'ha@naver.com');

insert into post (id, title, contents, author_id) values(2, 'a', 'abc', 1);
insert into post (id, title, contents, author_id) values(3, 'd', 'def', 2);
insert into post (id, title, contents, author_id) values(4, 'g', 'ghi', 3);
insert into post (id, title, contents, author_id) values(5, 'j', 'jkl', 3);
insert into post (id, title, contents, author_id) values(6, 'm', 'mno', 5);
...
select distinct title form post;

-- 정렬 : order by, 데이터의 출력결과를 특정 기준으로 정렬
-- 아무런 정렬조건없이 조회할 경우 pk기준을 오름차순 정렬
-- asc : 오름차순 // desc 내림차순 
